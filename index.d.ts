...
type AnyListener<E extends Events, K extends keyof E | '*' | symbol> = K extends '*'
  ? StarListener<E>
  : NanobusListener<E, K>;
...
declare class Nanobus<E extends Events = Events> {
  ...
  protected _emit<K extends keyof E | symbol>(
    array: StarListener<E>[],
    eventName: K,
    data: Parameters<NanobusListener<E, K>>,
    performanceTimingId?: string
  ): void;
